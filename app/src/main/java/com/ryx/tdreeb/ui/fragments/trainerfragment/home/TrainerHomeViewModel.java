...
public class TrainerHomeViewModel extends BaseViewModel<TrainerHomeNavigator> {

    @Inject
    public TrainerHomeViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
