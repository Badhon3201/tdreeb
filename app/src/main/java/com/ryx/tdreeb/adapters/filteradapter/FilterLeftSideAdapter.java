...
public class FilterLeftSideAdapter extends RecyclerView.Adapter<FilterLeftSideAdapter.ViewHolder> {

    Context context;
    List<String> list;
    private FilterBottomSheetFragment.OnClickBottomItem mListener;

    public FilterLeftSideAdapter(Context context, List<String> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_filter_left, parent, false);
